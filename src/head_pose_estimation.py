...
class Model_X:
    ...
    def load_model(self):
        ...
        print("Head Pose estimation model loaded")
...
'''
            To Test the code.
'''    
# a = Model_X(model_name='/home/workspace/starter/intel/head-pose-estimation-adas-0001/FP16/head-pose-estimation-adas-0001',extensions='/home/workspace/starter/bin/libcpu_extension_sse4.so')
